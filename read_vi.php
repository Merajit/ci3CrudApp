										...
										{               
											...
											<tr>
												...
												<td>
													...
													echo  anchor("read/getDiaryDetail/{$row['id']}",' ','class="btn btn-primary btn-xs glyphicon glyphicon-pencil"')?>
												</td>
												<td>
													<?php 
													//for passing row id to controller
													echo anchor("read/deleteToDo/{$row['id']}",' ','class="glyphicon glyphicon-trash btn-danger btn-xs"')?>
												</td>
											</tr>
											<?php 
